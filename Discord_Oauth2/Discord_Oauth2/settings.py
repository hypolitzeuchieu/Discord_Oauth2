"""
Django settings for Discord_Oauth2 project.
...
SECRET_KEY = 'django-insecure-uvcw%qlt_7napesewqy-n+8w=o)f(ils4dlcyop(s+ncu1f$7z'
...
ROOT_URLCONF = 'Discord_Oauth2.urls'
...
WSGI_APPLICATION = 'Discord_Oauth2.wsgi.application'
